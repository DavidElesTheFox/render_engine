...
namespace RenderEngine
{
    ...
    public:
        ...
        void registerRenderer(uint32_t id, std::function<std::unique_ptr<AbstractRenderer>(IWindow&, RenderTarget, uint32_t, AbstractRenderer*, bool)> factory_method);
    ...
    private:
        ...
        std::unordered_map<uint32_t, std::function<std::unique_ptr<AbstractRenderer>(IWindow&, RenderTarget, uint32_t, AbstractRenderer*, bool)>> _factory_methods;
    };
}